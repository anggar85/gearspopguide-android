...
public class CreateDeckActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ViewModels
        pinViewModel = ViewModelProviders.of(CreateDeckActivity.this).get(PinViewModel.class);
    ...
    private void agreaListenrClickHolders() {
        ...
        textView_save_deck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String token = AppPreferences.getInstance(CreateDeckActivity.this).getUserId();
                ...
                if (token.compareToIgnoreCase("") == 0) {
                    ...
                    deckModel.setUser_token(AppPreferences.getInstance(CreateDeckActivity.this).getUserId());
                    ...
                    if ((deck1_id.compareToIgnoreCase("") == 0) ||(deck2_id.compareToIgnoreCase("") == 0) ||
                        ...
                        Toast.makeText(CreateDeckActivity.this, "Select 8 pins", Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    private void initRecyclerView(final ArrayList<PinModel> pinModelsInternal) {
        ...
        PinsDeckAdapter adapter = new PinsDeckAdapter(pinModelsInternal, CreateDeckActivity.this, 1);
